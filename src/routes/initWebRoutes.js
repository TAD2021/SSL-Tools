...
const initWebRoutes = (app) =>  {
    ...
    router.get('/SSL/SSLFileConvert/PEMtoDER', uploadPEM, SSL_Controller.convertPEMtoDER)
    router.post('/SSL/SSLFileConvert/PEMtoPFX', uploadMultiPEM, SSL_Controller.convertPEMtoPFX)
    router.get('/SSL/SSLFileConvert/PEMtoP7B', uploadMultiPEM, SSL_Controller.convertPEMtoP7B)
    router.get('/SSL/SSLFileConvert/DERtoPEM', uploadDER, SSL_Controller.convertDERtoPEM)
    router.post('/SSL/SSLFileConvert/PFXtoPEM', uploadPFX, SSL_Controller.convertPFXtoPEM)
    router.get('/SSL/SSLFileConvert/P7BtoPEM', uploadP7B, SSL_Controller.convertP7BtoPEM)
